...
- **Faaliyet Yetkilendirmesi (Silme Kısıtı):**
  - Bir faaliyet kaydının (Activity) sadece onu oluşturan/açan kullanıcı tarafından silinebilmesi için `ActivityPolicy` yazıldı. Admin dahi olsa, kendisinin oluşturmadığı faaliyeti silemez.
